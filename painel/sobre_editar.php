...
<html>
  ...
  <body class="nav-md">
	...
	?>
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_sobre" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="sobre" id="sobre"  class="form-control col-md-7 col-xs-12" placeholder="Preencha a descrição.." required type="text"><?php echo $dados['sobre'];?></textarea>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='sobre.php'">Voltar</button>
