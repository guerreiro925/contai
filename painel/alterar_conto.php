          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h4 data-step="1" data-intro="Para corrigir um conto basta preencher os campos abaixo corretamente, clicar em 'SALVEAÍ' e 'PUBLICAR', pronto o conto corrigido estará em nosso sitema. Caso o conto tenha erro corrija-os, e clique em 'ENVIAR FEEDBACK' para voltar a página anterior clique em 'VOLTAR A PÁGINA ANTERIOR'.." data-position='center'>Editar Publique<span style="font-weight:bold; color:#025287">Aí</span></h4>
              </div>
...
<br /><br /><br />     
         ...
         <table border = "1" width = "100%" style="border-collapse: 1px #337ab7 solid; font-size:14px;">
            <tr>
                <td style="text-align:center; background-color:#fff;"><strong>Tipo de Correção</strong></td>
                <td style="text-align:center; background-color:#fff;"><strong>Legenda de Correção</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="background-color:#fff;"><strong>"<u>Frase ou período</u>"</strong></td>
