                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_usuarios" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="usuario" id="name" value="<?php echo $dados['usuario'];?>" class="form-control col-md-7 col-xs-12"placeholder="Usuário:" required type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Nova Senha:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="senha" id="senha" data-validate-length="6,7" placeholder="Digite a nova senha" required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" id="email" value="<?php echo $dados['email'];?>" required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
