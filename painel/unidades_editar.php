...
<html>
  <head>
	...
	<link href="img/icon-contai.png" rel="shortcut icon">
  ...
  <body class="nav-md">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <?php if($nivel == 'ADMIN'){?><li  class="active"><a href="unidades.php"><i class="fa fa-university"></i> Unidades </span></a></li><?php } ?>
                </ul>
                <ul class="nav side-menu">
	...
	<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM unidades WHERE idUnidade = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>

                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_unidades" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nome" id="nome" value="<?php echo $dados['nome'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha nome da unidade:" required type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='unidades.php'">Voltar</button>
