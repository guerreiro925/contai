...
<html lang="en">
  ...
  <div id="headerwrap" style="border-top:3px solid #fff;">
   ...
   <div class="container mtb">
	 	<div class="row">	 			
        	<span style="color:#fff; font-weight:bold; font-size:26px; text-transform:uppercase">Cadastrar</span><span style="color:#00b3fe; font-weight:bold; font-size:26px; text-transform:uppercase">Conheçai</span><br><br>
                <br><br>
                <center>
	 		<div class="col-lg-12">
...
<br/>       
	 			<form action="controlador.php?acao=add_sobre" method="post">
                    <div class="form-group" style="width:80%">
					  	<center><textarea placeholder="Sobre" name="sobre" class="form-control" id="sobre" rows="3" style="resize:vertical; text-indent:20px; height:180px;" required></textarea>
					  </div>
                      
                    
					   <center>
					  <button type="submit" class="btn btn-primary">CadastreAí</button>
                      <button type="button" class="btn btn-info" onClick="window.location.href='sobre.php'">Voltar</button>
