...
<div id="headerwrap" style="border-top:3px solid #fff;">
	    ...
	    <br><span style="color:#fff; font-weight:bold; font-size:26px; text-transform:uppercase">
 BEM VINDO<span style="color:#00b3fe; font-weight:bold; font-size:26px; text-transform:uppercase">AÍ</span></span><br><br><br>

            <span style="color:#fff; font-weight:bold; font-size:26px; text-transform:uppercase">
<?php
