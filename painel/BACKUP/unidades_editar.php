...
<br/>
	...
	?>
			...
			<form role="form" action="controlador.php?acao=editar_unidades" method="post">
                    
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    
					  <div class="form-group">
					    <input name="nome" value="<?php echo $dados['nome'];?>" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="nome" autofocus required placeholder="Nome Unidade">
					  </div>
