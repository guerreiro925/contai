...
<br/>
			...
			<form role="form" action="controlador.php?acao=add_categoria" method="post" enctype="multipart/form-data">
					  <div class="form-group">
					    <input name="nome" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="nomecategoria" autofocus required placeholder="Nome da Categoria">
					  </div>

                       <div class="form-group">
					<input type="file" name="imagem" id="imagemcategoria" class="form-control" placeholder="Carregar imagem" required></div>
					...
					<table>
                      ...
                      <td style="width:120px;">
						...
						<td>
					    <input name="cor1" style="text-indent:20px; height: 25px; width: 25px; " type="color"  id="cor1" required placeholder="Cor da Categoria (EX: #000000)" value="#01a976">
...
<tr>
					  ...
					  <td>
					    <input name="cor2" style="text-indent:20px; height: 25px; width: 25px; " type="color"  id="cor1" required placeholder="Cor da Categoria (EX: #000000)" value="#FFFFFF">
					  </div>
					  </td>
					  </tr>
					  </table>
					  <br>
                    <div class="form-group">
					  	<textarea placeholder="Descrição" name="descricao" class="form-control" id="descricaocategoria" rows="3" style="resize:vertical; text-indent:20px; height:180px;" required></textarea>
					  </div>
