...
<div class="col-md-3">
<a href="contos_incluir.php"><i class="fa fa-plus"></i>&nbsp;ADICIONAR CONTOS</a>
</div>
       <br>
           <br><br>               
       <table id="bootstrap-table"  width="100%" height="2%"border="2px" class="table table-responsive table-bordered table-striped" bordercolor="#FFFFFF" style="text-align: center; margin: 0 auto;">
	<tr>
    
    	<th style="font-size:16px">Código</th>
        <th style="font-size:16px">Unidade</th>
        <th style="font-size:16px">Ttulo</th>
        <th style="font-size:16px">Categoria</th>
...
?>    
	<tr>
		...
		<?php $queryA  = mysql_query("SELECT * FROM unidades WHERE idUnidade ='$idUnidade'");
						while($resultadoA = mysql_fetch_array($queryA)){
						echo $resultadoA['nome'];
						} 
						?></td>
        <td style="color:#FFFFFF; text-align:left;"><?php echo $dados['titulo'];?></td>
        <td style="color:#FFFFFF; text-align:left;">
		<?php $queryB  = mysql_query("SELECT * FROM categorias WHERE idCategoria ='$idCategoria'");
						while($resultadoB = mysql_fetch_array($queryB)){
						echo $resultadoB['nome'];
						} 
						?></td>
        <td style="color:#FFFFFF; text-align:left;"><?php echo $dados['data'];?></td>
        <td style="color:#FFFFFF; text-align:left;">
<a href="../categorias.php?idConto=<?php echo $dados['idConto'];?>&idCategoria=<?php echo $idCategoria;?>"><i class="fa fa-search" style="font-size:18px;"></i></a>
<a href="contos_editar.php?id=<?php echo $dados['idConto'];?>"><i class="fa fa-pencil" style="font-size:18px;"></i></a>
<a href="controlador.php?acao=excluir_contos&id=<?php echo $dados['idConto'];?>"><i class="fa fa-trash-o" style="font-size:18px;"></i></a>
