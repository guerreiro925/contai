  ...
  <div id="headerwrap" style="border-top:3px solid #fff;">
   ...
   <div class="container mtb">
	 	<div class="row">	 			
            ...
            <span style="color:#00b3fe; font-weight:bold; font-size:26px; text-transform:uppercase">Sobre</span><br><br>
                <center>
	 		<div class="col-lg-12">
...
<br/>
	...
	<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM sobre WHERE idSobre = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>     
	 			<form action="controlador.php?acao=editar_sobre" method="post">
                		...
                		<input type="hidden" name="id" value="<?php echo $id; ?>">
                        	...
                        	<textarea name="sobre" class="form-control" id="sobre" rows="3" style="resize:vertical; text-indent:20px; height:180px;" required><?php echo $dados['sobre'];?></textarea>
