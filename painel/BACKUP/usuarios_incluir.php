...
<br/>
			...
			<form role="form" action="controlador.php?acao=add_usuarios" method="post">
					  <div class="form-group">
					    <input name="usuario" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="usuario" autofocus required placeholder="Usuário">
					  </div>
                      
                       <div class="form-group">
					    <input name="senha" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="senha" autofocus required placeholder="Senha">
					  </div>
                      
                      <div class="form-group">
					    <input name="email" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="email" autofocus required placeholder="Email">
					  </div>
					...
					?>
                      ...
                      <?php if($nivel == 'ADMIN'){?>
                      <div class="form-group">
					    <select name="nivel" style="text-indent:20px; height: 40px;" type="text" class="form-control" id="nivel" autofocus required>
