...
<div class="col-md-3">
<a href="categorias_incluir.php"><i class="fa fa-plus"></i>&nbsp;ADICIONAR CATEGORIA</a>
</div>
       <br>
           <br><br>               
	...
	<tr>
        ...
        <th style="font-size:16px">Imagem</th>
...
?>    
	<tr>
    	<td style="color:#FFFFFF; text-align:left;"><?php echo $dados['idCategoria'];?></td>
        <td style="color:#FFFFFF; text-align:left;"><?php echo $dados['nome'];?></td>
        <td style="color:#FFFFFF; text-align:left; width:8%"><img src="<?php echo $dados['imagem'];?>"  width="80%"></td>
        <td style="color:#FFFFFF; text-align:left;"><?php echo $dados['descricao'];?></td>
        <td style="color:#FFFFFF; text-align:left;">
<a href="categorias_editar.php?id=<?php echo $dados['idCategoria'];?>"><i class="fa fa-pencil" style="font-size:18px;"></i></a>
<a href="controlador.php?acao=excluir_categoria&id=<?php echo $dados['idCategoria'];?>"><i class="fa fa-trash-o" style="font-size:18px;"></i></a>
        </td>
    </tr>
