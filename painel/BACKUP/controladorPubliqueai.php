...
if ($acao == 'enviar_feedback') {
	...
	$feedback2 = utf8_decode(strip_tags(trim($_POST['feedback'])));
	...
	while($dados = mysql_fetch_array($consulta)){
		...
		while($dados2 = mysql_fetch_array($consulta2)){
			...
			$Email->Host = 'smtp-mail.outlook.com'; // Servidor de envio # verificar qual o host correto com a hospedagem as vezes fica como smtp.
			$Email->Port = '587'; // Porta de envio
			$Email->Username = 'contaiprojeto@outlook.com'; //e-mail que ser� autenticado
			$Email->Password = 'contai123'; // senha do email
