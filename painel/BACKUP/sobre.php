...
<html lang="en">
  ...
  <div id="headerwrap" style="border-top:3px solid #fff;">
	    <div class="container">
            ...
            <span style="color:#00b3fe; font-weight:bold; font-size:26px; text-transform:uppercase">Conheçai</span>
...
<?php
$consulta = mysql_query("SELECT * FROM sobre WHERE deletar != '1' ORDER BY sobre ASC");
while ($dados = mysql_fetch_array($consulta))
{
?>    
	<tr style="color:#FFFFFF;">
    	<td style="color:#FFFFFF; text-align:left;"><?php echo $dados['idSobre'];?></td>
        <td style="color:#FFFFFF; text-align:left;"><?php echo substr($dados['sobre'], 0, 100);?>...</td>
       <style>
       p{
       	color:#ffffff;
       }
...
<a href="sobre_editar.php?id=<?php echo $dados['idSobre'];?>"><i class="fa fa-pencil" style="font-size:18px;"></i></a>
        </td>
    </tr>
