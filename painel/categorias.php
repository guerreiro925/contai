                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="btn btn-dark">
                        <a href="categorias_incluir.php" style="color: #fff"><i class="fa fa-plus-circle"></i>&nbsp;Adicionar categoria</a>
                  </p>
...
while ($dados = mysql_fetch_array($consulta))
{
	?>	
                        <tr>
                            ...
                            <td><img src="<?php echo $dados['imagem']; ?>" width="100" class="img-responsive center-margin"></td>
                            <td class="contotd"><?php echo $dados['descricao']; ?></td>
                            <td class="contotd"><?php echo $dados['cor']; ?></td>
                            <td class="contotd"><?php echo $dados['cor_fonte']; ?></td>
