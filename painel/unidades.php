                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="btn btn-dark">
                        <a href="unidades_incluir.php" style="color: #fff"><i class="fa fa-plus-circle"></i>&nbsp;Adicionar unidade</a>
                  </p>
...
while ($dados = mysql_fetch_array($consulta))
{
	?>	
                        <tr>
                        	<th><?php echo $dados['idUnidade']; ?></th>
                        	<td><?php echo $dados['nome']; ?></td>
                            <td><a href="unidades_editar.php?id=<?php echo $dados['idUnidade'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_unidades&id=<?php echo $dados['idUnidade'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
