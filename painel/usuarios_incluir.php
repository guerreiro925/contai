                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_usuarios" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Confirmação de Senha:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="senha" id="senha" data-validate-linked="senha" placeholder="Preencha a confirmação de senha.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" id="email" placeholder="Preencha o email.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Confirmação email:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" id="email" placeholder="Preencha a confirmação de email.." required  data-validate-linked="email" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="unidade" required class="form-control col-md-7 col-xs-12 required">
...
<?php if($nivel == 'ADMIN'){?>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="nivel" required class="form-control col-md-7 col-xs-12 required">
