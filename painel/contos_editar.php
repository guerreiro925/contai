...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content" data-step="1" data-intro="Para EDITAR um conto, basta preencher todos os campos que deseja alterar e clicar em 'SALVEAÍ' depois 'VOLTAR'" data-position='center'>
	...
	?>
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_contos" enctype="multipart/form-data" method="post" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="name" name="unidade" class="form-control col-md-7 col-xs-12" required type="text">
<?php
	if($nivel == 'ADMIN'){
...
<?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="file" value="<?php echo $dadosA['titulo'];?>" name="titulo" placeholder="Preencha o titúlo.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
...
<?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="autor" id="autor" placeholder="Preencha o autor.." value="<?php echo $dadosA['autor'];?>" required class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="idade" id="idade" value="<?php echo $dadosA['idade'];?>" placeholder="Preencha a idade.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="imagem" id="imagem" value="<?php echo $dadosA['imagem'];?>" class="form-control date">
                        <img class="img-responsive" width="100" src="<?php echo $dadosA['imagem'];?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="conto" id="texto" rows="12" required placeholder="Preencha o conto.." class="form-control col-md-7 col-xs-12"><?php echo $dadosA['conto'];?></textarea>
                        </div>
                      </div>
