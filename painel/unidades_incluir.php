              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_unidades" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nome" id="nome" class="form-control col-md-7 col-xs-12"placeholder="Preencha a Unidade.." required type="text">
                        </div>
                      </div>
