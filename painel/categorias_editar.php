                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_categoria" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" name="nome" value="<?php echo $dados['nome'];?>" class="form-control col-md-7 col-xs-12"  name="name" placeholder="Preencha o nome da categoria:" required type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Imagem</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="file" value="<?php echo $dados['imagem'];?>" name="imagem" placeholder="Selecione uma imagem:"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Descrição</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="descricao" placeholder="Preencha a descrição.." id="texto" rows="12" required class="form-control col-md-7 col-xs-12"><?php echo $dados['descricao'];?></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Cor da categoria:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="color" id="color" value="<?php echo $dados['cor'];?>" name="cor1" required class="color ">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Cor da fonte:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="color" id="cor" value="<?php echo $dados['cor_fonte'];?>" name="cor2" required class="color ">
                        </div>
                      </div>
